...
if __name__ == "__main__":
    ...
    test_post_list = [sample["prompt"] for sample in load_dataset(cfg.SUMMARIZATION_DATASET, split="test")]
    test_summ_list = [sample["label"] for sample in load_dataset(cfg.SUMMARIZATION_DATASET, split="test")]
